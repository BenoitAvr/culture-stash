    ...
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '48px 24px' }}>
      ...
      <div style={{ background: '#161616', border: '1px solid #2a2a2a', borderRadius: 12, padding: 28 }}>
        ...
        <form action={action} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div>
            <label style={{ display: 'block', fontSize: 12, color: '#aaa', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '.06em' }}>{t.typeLabel}</label>
            <select name="type" required style={{ width: '100%', background: '#1e1e1e', border: '1px solid #2a2a2a', borderRadius: 8, padding: '10px 14px', color: '#f0f0f0', fontSize: 14, outline: 'none', fontFamily: 'inherit', cursor: 'pointer' }}>
          ...
          <div>
            <label style={{ display: 'block', fontSize: 12, color: '#aaa', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '.06em' }}>{t.sourceLabel}</label>
            <input name="sub" type="text" required style={{ width: '100%', background: '#1e1e1e', border: '1px solid #2a2a2a', borderRadius: 8, padding: '10px 14px', color: '#f0f0f0', fontSize: 14, outline: 'none', fontFamily: 'inherit' }} />
          </div>

          <div>
            <label style={{ display: 'block', fontSize: 12, color: '#aaa', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '.06em' }}>
              {t.urlLabel} <span style={{ color: '#555', textTransform: 'none', letterSpacing: 0 }}>{t.urlOptional}</span>
            </label>
            <input name="url" type="url" placeholder="https://..." style={{ width: '100%', background: '#1e1e1e', border: '1px solid #2a2a2a', borderRadius: 8, padding: '10px 14px', color: '#f0f0f0', fontSize: 14, outline: 'none', fontFamily: 'inherit' }} />
          </div>
